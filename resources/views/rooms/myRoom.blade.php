            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><i class="fas fa-box-open package-sign"></i>&nbsp;&nbsp;<a class="text" href="{{ route('room.users.packages',['id' => $room->id]) }}">ตรวจสอบพัสดุ</a><span class="badge badge-danger">{{  $r }}</span></li>
                    </ul>
                </div>
            </div>
{{--            <div class="col-md-3">--}}
